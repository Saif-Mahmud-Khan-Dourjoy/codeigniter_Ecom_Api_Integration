...
class Home extends CI_Controller
{
    ...
    function profile($para1="",$para2="",$para3="")
    {
        ...
        elseif($para1=="review"){
            $page_data['reviews'] = $this->db->get_where('review',array('user_id'=>$this->session->userdata('user_id')))->result_array();
            $this->load->view('front/user/review',$page_data);
        }
    ...
    function product_view($para1 = "",$para2 = "")
    {
        ...
        /* FUNCTION: Loads Product View Page */
        function product_view1($para1 = "",$para2 = "")
        {
            /*$is_bundle = $this->db->get_where('product', array('product_id' => $para1))->row()->is_bundle;
            if ($this->crud_model->get_type_name_by_id('general_settings','82','value') == 'ok') {
            }*/
            ...
            $product_data       = $this->db->get_where('upcoming_product', array('upcoming_product_id' => $para1,'status' => 'ok'));
    
            $this->db->where('upcoming_product_id', $para1);
            $this->db->update('upcoming_product', array(
                'number_of_view' => $product_data->row()->number_of_view+1,
                'last_viewed' => time()
            ));
            ...
            $page_data['product_details']=$this->db->get_where('upcoming_product', array('upcoming_product_id' => $para1,'status' => 'ok'))->result_array();
            $page_data['page_name']    = "upcoming_product_view/".$type."/page_view";
            $page_data['asset_page']   = "upcoming_product_view_".$type;
            $page_data['product_data'] = $product_data->result_array();
            $page_data['page_title']   = $product_data->row()->title;
            $page_data['product_tags'] = $product_data->row()->tag;
    ...
    function quick_view($para1 = "")
    {
        ...
        /* FUNCTION: Loads Product View Page */
        function quick_view1($para1 = "")
        {
            $product_data = $this->db->get_where('upcoming_product', array(
                'upcoming_product_id' => $para1,
                'status' => 'ok'
            ));
            ...
            $this->load->view('front/upcoming_product_view/'.$type.'/quick_view/index', $page_data);
        }
