            ...
            <div class="tab-content">
                <div id="tabb-1" class="tab-pane fade active in">
                    <div class="row">
                        <div class="col-md-12 form-horizontal">
                            ...
                            <?php
                            echo form_open(base_url() . 'admin/ui_settings/ui_home/top_slide_categories/', array(
                    ...
                    <div class="row">
                        <div class="col-md-12 form-horizontal">
                            ...
                            foreach($home_banner as $row){
                                ...
                                <div class="col-md-3">
                                    <?php
                                    echo form_open(base_url() . 'admin/banner/set/'. $row['banner_id'], array(
                                        'class' => 'form-horizontal',
                                        'method' => 'post',
                                        'enctype' => 'multipart/form-data'
                                    ));
                ...
                <div id="tabb-3" class="tab-pane fade">
                    <div class="row">
                        <div class="col-md-12 form-horizontal">
                            <?php
                            echo form_open(base_url() . 'admin/ui_settings/ui_home/todays_deal/', array(
                                'class' => 'form-horizontal',
                                'method' => 'post',
                                'id' => '',
                                'enctype' => 'multipart/form-data'
                            ...
                            ?>
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo translate('todays_deal_(_show_/_hide_)');?></label>
                                <div class="col-sm-6">
                                    <input id="feature_59"
                                           data-id="59" class='sw2'
                                           type="checkbox" name="value"
                                           <?php if($this->crud_model->get_type_name_by_id('ui_settings','59','value') == 'ok'){
                                           ?>checked<?php } ?>
                                           value="ok" />
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="number" name="flash_no" value="<?php echo $this->crud_model->get_type_name_by_id('ui_settings','61','value'); ?>"  class="form-control">
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        foreach($style as $value){
                                            ...
                                            <div class="cc-selector col-sm-4">
                                                <input type="radio" id="deal_box_<?php echo $value; ?>" value="<?php echo $value; ?>" name="deal_pro_box" <?php if($box_style == $value){ echo 'checked'; } ?> >
                                                <label class="drinkcard-cc" style="margin-bottom:0px; width:100%;" for="deal_box_<?php echo $value; ?>">
                            ...
                            <div class="form-group col-sm-12">
                                <span class="btn btn-success btn-labeled fa fa-check submitter pull-right enterer" type= data-ing='<?php echo translate('updating'); ?>' data-msg='<?php echo translate('flash_section_updated!'); ?>'>
                                    <?php echo translate('update');?>
                                </span>
                            </div>
                            </form>
                ...
                <div id="tabb-10" class="tab-pane fade">
                    <div class="row">
                        <div class="col-md-12 form-horizontal">
                            <?php
                            echo form_open(base_url() . 'admin/ui_settings/ui_home/product_bundle/', array(
                                'class' => 'form-horizontal',
                                'method' => 'post',
                                'id' => '',
                                'enctype' => 'multipart/form-data'
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="product_bundle_40"
                                           ...
                                           type="checkbox" name="value"
                                           <?php if($this->crud_model->get_type_name_by_id('ui_settings','40','value') == 'ok'){
                                           ?>checked<?php } ?>
                                           value="ok" />
                                </div>
                            </div>
                ...
                <div id="tabb-11" class="tab-pane fade">
                    <div class="row">
                        <div class="col-md-12 form-horizontal">
                            <?php
                            echo form_open(base_url() . 'admin/ui_settings/ui_home/customer_product/', array(
                                'class' => 'form-horizontal',
                                'method' => 'post',
                                'id' => '',
                                'enctype' => 'multipart/form-data'
...
<script>
    ...
    function get_cat(id,now){
        ...
        parent.find('.sub_cat').load(base_url+'admin/ui_settings/sub_by_cat/'+id,
            function(){
    ...
    $(document).ready(function() {
        ...
        $(".sw1").each(function() {
            ...
            changeCheckbox.onchange = function() {
                ajax_load('<?php echo base_url(); ?>admin/banner/banner_publish_set/' + $(this).data('id') + '/' + changeCheckbox.checked, 'prod', 'others');
                if (changeCheckbox.checked == true) {
                    $.activeitNoty({
                        type: 'success',
                        icon: 'fa fa-check',
        ...
        $(".sw2").each(function() {
            ...
            changeCheckbox.onchange = function() {
                ajax_load('<?php echo base_url(); ?>admin/ui_settings/ui_home/feature_publish_set/' + $(this).data('id') + '/' + changeCheckbox.checked, '', '');
                if (changeCheckbox.checked == true) {
                    $.activeitNoty({
                        type: 'success',
                        icon: 'fa fa-check',
        ...
        $(".sw3").each(function() {
            new Switchery(document.getElementById('product_bundle_' + $(this).data('id')), {
                color: 'rgb(100, 189, 99)'
            });
            var changeCheckbox = document.querySelector('#product_bundle_' + $(this).data('id'));
            changeCheckbox.onchange = function() {
                ajax_load('<?php echo base_url(); ?>admin/ui_settings/ui_home/product_bundle_publish_set/' + $(this).data('id') + '/' + changeCheckbox.checked, '', '');
                if (changeCheckbox.checked == true) {
                    $.activeitNoty({
                        type: 'success',
                        icon: 'fa fa-check',
