...
<div class="row">
    <div class="col-md-12">
        <?php
			echo form_open(base_url() . 'admin/upcoming_product/update/' . $row['upcoming_product_id'], array(
                    ...
                    <div class="tab-content">
                        <div id="product_details" class="tab-pane fade active in">
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    <?php 
                                        $images = $this->crud_model->file_view('upcoming_product',$row['upcoming_product_id'],'','','thumb','src','multi','all');
                                        if($images){
                ...
                <div class="row">
                    <div class="col-md-11">
                    	<span class="btn btn-purple btn-labeled fa fa-refresh pro_list_btn pull-right" 
                            onclick="ajax_set_full('edit','<?php echo translate('edit_product'); ?>','<?php echo translate('successfully_edited!'); ?>','product_edit','<?php echo $row['upcoming_product_id']; ?>') "><?php echo translate('reset');?>
                        </span>
                     </div>
                     <div class="col-md-1">
