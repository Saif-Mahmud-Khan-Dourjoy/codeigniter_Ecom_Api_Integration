                ...
                <div class="col-lg-3 col-md-3">
                    ...
                    <div class="information-title" style="margin-bottom: 0px;"><?php echo translate('my_profile');?></div>
                        <ul class="pleft_nav">
                            ...
                            <a class="pnav_review" href="#"><li><?php echo translate('site_review');?></li></a>
...
<script>
    ...
    $('.pnav_review').on('click',function(){
        $("#profile_content").html(loading_set);
        $("#profile_content").load("<?php echo base_url()?>home/profile/review");
        $(".pleft_nav").find("li").removeClass("active");
        $(".pnav_review").find("li").addClass("active");
    });
