...
class Crud_model extends CI_Model
{
    ...
    function product_link($product_id,$quick='')
    {
        ...
        //GET PRODUCT LINK
        function product_link1($product_id,$quick='')
        {
            if($quick=='quick'){
                return base_url() . 'home/quick_view1/' . $product_id;
            } else {
                $name = url_title($this->crud_model->get_type_name_by_id('upcoming_product', $product_id, 'title'));
                return base_url() . 'home/product_view1/' . $product_id . '/' . $name;
            }
        }
